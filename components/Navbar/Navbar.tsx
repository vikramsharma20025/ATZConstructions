...
function NavigationTop() {
    ...
    return (
        <div className=' sticky top-0 fixed z-20 bg-white'>
            <nav className="flex flex-row justify-evenly w-full items-center mt-0 h-fit p-4">
                <div className='w-1/3 md:content-start'>
                    <a href="/">
                        <Image src={logo} className='h-20 mx-auto' alt="logo" width={100} height={100} />
                    </a>
                </div>
                <div className="mx-auto md:hidden w-auto h-full ml-auto">
                ...
                <div className="md:flex md:flex-row hidden md:block md:w-2/3 md:justify-between md:mt-0 md:content-center md:items-center md:text-black md:h-full md:pr-20 font-medium">
                    ...
                    <Button onClick={()=>router.push('/contact-us')} className='bg-[#922F25] rounded-full h-2/3 px-8 py-3 hover:bg-black text-white font-bold'>
                        Contact Us
                    </Button>
                </div>
            </nav>
